...
## 3. Features
### F-001 — Product Grid
- **What it does:** Shows a grid of products pulled from a Shopify collection. Reused on the Shop page, the three category pages, and the "You May Also Like" block.
...
| D-005 | Size Chart | App repo config file | Per-product cm measurements, as a TSV. Inches are worked out from these. |
...
- **Behavior:**
  - A thumbnail sets the main image.
...
| B-007 | Build the size chart drawer (from the size-chart TSV) and the shipping drawer. | C-Sizing, C-Shipping, F-007, D-005, /docs/content/s-012_shipping-returns.md |
