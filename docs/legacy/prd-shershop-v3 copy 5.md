...
| B-003 | Build the global chrome: C-Transparent, C-Sticky (with the 60vh takeover), C-Menu, C-Footer, the announcement bar, and the navigation. | C-Transparent, C-Sticky, C-Menu, C-Footer, D-007, Navigation |
