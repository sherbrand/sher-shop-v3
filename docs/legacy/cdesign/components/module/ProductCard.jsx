...
export function ProductCard({
  ...
  const titleStyle = {
    fontFamily: "var(--font-body)", fontSize: "var(--fs-item, var(--text-item-lg))",
  ...
  const eyebrowStyle = {
    ...
    letterSpacing: "var(--tracking-control)", textTransform: "uppercase",
      ...
      <div style={{ position: "relative", aspectRatio: "3 / 4", overflow: "hidden",
        ...
        {soldOut && (
          <span style={{ position: "absolute", top: "var(--space-3)", left: "var(--space-3)",
            ...
            textTransform: "uppercase", padding: "0.25rem 0.6rem", borderRadius: "var(--radius-sm)" }}>
            Sold Out</span>
        )}
      </div>
