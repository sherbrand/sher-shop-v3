...
export function Footer({
  ...
  const link = {
    display: "block", padding: "var(--pad-row-sm) 0", fontFamily: "var(--font-body)",
    fontSize: "var(--size-sm)", color: "var(--text-on-inverse)", textDecoration: "none",
      ...
      <div style={{ maxWidth: "var(--container)", margin: "0 auto" }}>
        <div className="sher-footer-grid">
          ...
          <div className="sher-footer-connect" style={{ textAlign: "center" }}>
            ...
            <div style={{ display: "flex", gap: "var(--space-4)", marginTop: "var(--pad-row-sm)", justifyContent: "center" }}>
              {socialLinks.map((s) => (
        ...
        <div style={{
          ...
          fontSize: "var(--size-xs)", letterSpacing: "var(--tracking-item)", opacity: 0.7,
        }}>
          <span>© SHER {year}</span>
