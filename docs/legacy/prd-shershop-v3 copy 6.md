...
### F-008 — Home Content
- **What it does:** Renders the Home hero carousel, the category tiles, and the featured products from D-004 Home content. Each slot gives placement, image, overlay text, and link; featured products are curated by product name, URL, and image, not pulled from a collection. The hero slides.
...
| D-004 | Home Content | App repo config file | Hero banners, category tiles, and featured products (each as product name, URL, image, and link). Each slot gives placement, image, overlay text, and link. |
...
- **Feature:** None
- **Behavior:**
  - The social messaging links, email, and address come from /docs/knowledge-sher.md.
- **Components & Assets:**
  - (to be updated later)
