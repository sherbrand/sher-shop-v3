...
- **C-HeroCarouselStg** — full-bleed crossfade hero band; `surfaceInverse` panel, `white` overlay text. Auto-advances with arrows and dots. Props: `slides`, `interval`, `height`, `autoPlay`.
