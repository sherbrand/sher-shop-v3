...
const SIZES = {
  sm: { fontSize: "var(--size-xs)", padding: "var(--space-2) var(--space-4)", letterSpacing: "var(--tracking-label)" },
  md: { fontSize: "var(--size-sm)", padding: "var(--space-3) var(--pad-btn-md)", letterSpacing: "var(--tracking-label)" },
  lg: { fontSize: "var(--size-base)", padding: "var(--space-4) var(--pad-btn-lg)", letterSpacing: "var(--tracking-label)" },
};
