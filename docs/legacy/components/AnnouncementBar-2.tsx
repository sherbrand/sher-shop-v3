...
export function AnnouncementBar({
  ...
  return (
    <div
      ...
      className={`flex h-[var(--announce-h)] w-full items-center justify-center px-[var(--gutter)] text-center font-[family-name:var(--font-body)] text-[length:var(--fs-announce,var(--text-announce-lg))] uppercase tracking-[var(--tracking-control)] ${TONES[tone]} ${className}`}
    >
      {children}
    </div>
  );
