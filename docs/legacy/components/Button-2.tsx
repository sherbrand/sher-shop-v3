...
const SIZES: Record<NonNullable<ButtonProps["size"]>, string> = {
  sm: "text-[length:var(--text-xs)] px-[var(--space-4)] py-[var(--space-2)]",
  md: "text-[length:var(--text-sm)] px-[var(--pad-btn-md)] py-[var(--space-3)]",
  lg: "text-[length:var(--text-base)] px-[var(--pad-btn-lg)] py-[var(--space-4)]",
};
...
export function Button({
  ...
  const cls = [
    ...
    "font-[family-name:var(--font-button)] font-medium uppercase tracking-[var(--tracking-control)]",
