...
export function ButtonPill({
  ...
  const Tag = as;
  const cls = [
    "inline-flex cursor-pointer items-center justify-center whitespace-nowrap no-underline",
    "font-[family-name:var(--font-button)] font-medium uppercase leading-none text-[length:var(--text-xs)] tracking-[var(--tracking-5)]",
    "px-[var(--pad-pill-x)] py-[var(--pad-pill-y)] rounded-[var(--radius-pill)] border",
