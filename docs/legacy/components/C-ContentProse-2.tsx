...
/* C-ContentProse — the policy page band (shipping & returns, privacy, terms):
   a full-width section that centers a run of heading + paragraph blocks at a
   readable measure. Owns its own band padding, content width, heading/body sizes
   and block rhythm, all stepped by container queries on its OWN width. A page only
   places it.
...
export function ContentProse({
  ...
  return (
    <section
      ...
      style={{ paddingTop: paddingTop ?? undefined, background: background || "transparent" }}
    >
      <div
