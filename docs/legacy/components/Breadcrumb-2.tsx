...
export function Breadcrumb({
  ...
  return (
    <nav
      ...
      className={`flex flex-wrap items-center gap-[var(--space-2)] font-[family-name:var(--font-body)] text-[length:var(--text-xs)] uppercase tracking-[var(--tracking-control)] ${className}`}
    >
      {items.map((item, i) => {
