...
import { MediaGallery } from "../module/MediaGallery.jsx";
...
export function ProductPanel({
  ...
  const linkStyle = {
    ...
    fontFamily: "var(--font-body)", fontSize: "var(--size-sm)",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)" }}>
          {allSoldOut ? (
            ...
            <>
              <Button variant="surface" size="lg" fullWidth onClick={onAddToCart}>Add to Cart</Button>
        ...
        {(description || attributeValue) && (
          <div style={{ display: "flex", flexDirection: "column", gap: "var(--space-3)",
            ...
            {attributeValue && (
              <p style={{ margin: 0, fontFamily: "var(--font-body)", fontSize: "var(--size-sm)",
                color: "var(--text-meta)" }}>
