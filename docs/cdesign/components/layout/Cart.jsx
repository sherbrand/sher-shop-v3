              ...
              <div key={it.id} style={{ display: "flex", gap: "var(--space-4)" }}>
                ...
                <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", gap: "var(--space-3)" }}>
                    <span style={{ fontFamily: "var(--font-body)", fontSize: "var(--size-base)",
                  ...
                  {it.options && <span style={{ fontSize: "var(--size-sm)",
        ...
        {!empty && (
          <div style={{ borderTop: "1px solid var(--border-default)", padding: "var(--space-5)" }}>
            ...
            <p style={{ margin: "var(--space-3) 0 0", textAlign: "center",
              fontSize: "var(--size-xs)", color: "var(--text-meta)", letterSpacing: "var(--tracking-item)" }}>
