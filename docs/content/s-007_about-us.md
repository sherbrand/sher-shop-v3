...
description: "{Meet the SHER brand: sensual, refined womenswear built by hand from real corsetry. Read our philosophy and the story of founder Sherilyn.}"
url: /about
---

`S-007.1: Breadcrumb <Home › About Us> / H1 / Paragraph`
- H1: {Our SHER Brand}
- Paragraph: {The SHER brand makes womenswear that is sensual and refined. We believe sensuality should lift a woman up, never cheapen her. Every piece is built by hand, one at a time, on real corsetry. Corset tops, matching sets, and cocktail dresses that shape the body and read elegant. We started SHER because premium, well-made sensual clothing was hard to find, so we make it ourselves.}

`S-007.2: Image#1 | (Eyebrow / H2 / Paragraph)`
