...
export function ButtonPill({
  ...
  const cls = [
    ...
    "font-[family-name:var(--font-button)] text-[length:var(--size-xs)] font-medium uppercase leading-none",
    "tracking-[var(--tracking-label)] px-[var(--pad-pill-x)] py-[var(--pad-pill-y)]",
