...
//  Query strings live in ./queries, mutation strings in ./mutations.
// ============================================================
...
// Shopify ships a new API version each quarter (YYYY-MM). Override via env when
// it is time to bump; the default keeps the app running without extra config.
...
export async function shopifyFetch<T>({
  ...
  console.log(`[shopify] POST ${endpoint}`); // debug log (data-layer trace)
